    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../controlador/administrador.php"><?php echo $titulo ?></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="../controlador/administrador.php"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <?php if( $tipo == 'admin' || $tipo=='profesional' || $tipo == 'cliente'){?>
                    <li <?php if($tipo=='usuario') echo 'class="active" '?> >
                        <a href="../controlador/administrador.php"><i class="fa fa-fw fa-dashboard"></i> Usuarios</a>
                    </li>
                    <?php } if($tipo=='profesional' || $tipo == 'admin'){?>
                    <li <?php if($tipo=='profesional') echo 'class="active" '?>>
                        <a href="../controlador/administrador.php"><i class="fa fa-fw fa-edit"></i> Profesional</a>
                    </li>
                    <?php } ?>
                    <?php if($tipo=='admin'){?>
                    <li <?php if($tipo=='admin') echo 'class="active" '?>>
                        <a href="../controlador/administrador.php"><i class="fa fa-fw fa-desktop"></i> Administradores</a>
                    </li>
                    <?php } ?>
                    <li>
                        <a href="../vista/bootstrap-grid.html"><i class="fa fa-fw fa-wrench"></i> Colas</a>
                    </li>
